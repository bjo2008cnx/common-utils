...
public class ZipEncryptRSA {
    ...
    public static void encryptZip(String srcFile, String destfile,
        ...
        // 获得私匙
        ZipEncryptRSA.privateKey = kp.getPrivate();
        // 获得公钥
        ZipEncryptRSA.publicKey = kp.getPublic();
        File f = new File(keyfile);
        f.createNewFile();
        FileOutputStream fos = new FileOutputStream(f);
        ObjectOutputStream dos = new ObjectOutputStream(fos);
        dos.writeObject(ZipEncryptRSA.publicKey);
    ...
    public static void main(String args[]) throws Exception {
        ...
        ZipEncryptRSA.encryptZip("E:/download/tmp", "E:/download/tmp.zip", "E:/download/b.key");
